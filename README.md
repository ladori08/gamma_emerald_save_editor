...
[Item Mod Builder guide](docs/ITEM_MOD_BUILDER.md) covers the v0.15.1 multi-archetype wizard,
...
Version 0.15.1 uses an Indigo-style consumer workspace instead of exposing raw schema rows:
